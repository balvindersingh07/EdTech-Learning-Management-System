export const seedData = {
  users: [
    { id: "u1", name: "Alex Morgan", email: "alex@example.com", password: "password", role: "student" },
    { id: "u2", name: "Priya Sharma", email: "priya@example.com", password: "password", role: "instructor" },
    { id: "u3", name: "Jordan Lee", email: "jordan@example.com", password: "password", role: "admin" },
  ],
  courses: [
    {
      id: "c1",
      ...
      modules: [
        {
          id: "m4",
          title: "Discovery",
          lectures: [{ id: "l8", title: "Problem framing", durationMin: 24, type: "video" }],
        },
      ],
    },
  ],
